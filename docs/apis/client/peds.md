...
Batch deletion of all managed peds.
...
- Use `blockEvents: true` to prevent NPCs from reacting to ambient game events (shots, crashes), which is standard for quest or shop NPCs.
